...
export default function CacRegistrationScreen() {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      proprietor: { surname:f.propSurname, firstName:f.propFirstName, otherName:f.propOtherName, dob:f.propDOB, gender:f.propGender, occupation:f.propOccupation, phone:f.propPhone, email:f.propEmail, nin:f.propNIN, resAddress:f.propResAddress },
