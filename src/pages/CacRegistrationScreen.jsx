    ...
    return (
      <div className="min-h-screen bg-[#F4F6F9] dark:bg-[#0A192F]">
        ...
        <div className="px-6 pt-10 text-center">
          ...
          <button onClick={() => { setSuccess(false); setName1(''); setEmail(''); }} className="w-full py-4 bg-[#0A192F] dark:bg-[#D4AF37] text-[#D4AF37] dark:text-[#0A192F] rounded-xl font-bold">Done</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F9] dark:bg-[#0A192F]">
      ...
      <div className="px-5 pt-4 space-y-4">
        ...
        <button onClick={handleSubmit} disabled={loading || !name1 || !email} className="w-full py-4 bg-[#0A192F] dark:bg-[#D4AF37] text-[#D4AF37] dark:text-[#0A192F] rounded-xl text-base font-bold disabled:opacity-50 active:scale-[0.98] transition-transform flex items-center justify-center">
